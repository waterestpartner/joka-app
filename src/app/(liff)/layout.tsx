...
// LIFF 根佈局：初始化 LIFF、全域 loading/error、底部導航列
  ...
  },
  {
    ...
    icon: (active: boolean) => (
      ...
      >
        ...
        <path
          d="M12 6v1m0 10v1M9 12h-.5m7.5 0H15.5M10.5 9.5a1.5 1.5 0 0 1 3 0c0 1.5-3 2-3 3.5h3"
          stroke="currentColor"
          strokeWidth={1.8}
          strokeLinecap="round"
          fill="none"
...
export default function LiffLayout({
  ...
  // Register page has its own full-screen flow — no bottom nav
  const showNav = !pathname.startsWith('/register')
