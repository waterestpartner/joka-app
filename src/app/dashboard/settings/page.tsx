        ...
        {loading ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input id="name" name="name" type="text" required value={settings.name} onChange={handleChange} placeholder="例：JOKA 咖啡"
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-zinc-400">從 LINE Developers Console 取得</p>
            </div>
